...
class ManagePages extends Page {
	...
	public function Load() {
		...
		$tree_obj->setAlign(WSPObject::ALIGN_LEFT)->setWidth(220)->setHeight(630)->setMaxHeight(630);
		...
		if (Page::getInstance("wsp-admin/manage/manage-translations")->userHaveRights()) {
			$this->tranlate_links_obj = new WSPObject(__(MANAGE_TRANSLATIONS).": ");
			$this->tranlate_links_obj->setId("tranlate_links_obj");
		}
		
		$code_editor_table->addRow(new WSPObject($this->tranlate_links_obj, "&nbsp;", $this->btn_save))->setColspan(2);
